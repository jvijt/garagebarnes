...
function gb_auto_service_shortcode(){
    ...
    $content='<div class="gb-content-grid"><div><h2>Onderhoud en herstellingen voor alle merken</h2><p>Garage Barnes staat in voor klein en groot onderhoud, herstellingen en technische diagnose. We communiceren duidelijk en voeren geen bijkomende werken uit zonder uw toestemming.</p><div class="gb-service-list"><span>Klein en groot onderhoud</span><span>Allerlei herstellingen <small>Remmen, remschijven, koppeling, versnellingsbak, glasbreuk, distributieriem of ketting, schokdempers, injectoren, waterpompen, uitlaten en nog veel meer…</small></span><span>Motorwissels</span><span>Elektrische diagnose</span><span>Airco onderhoud en herstelling</span><span>Batterijen en banden</span><span>Depannages</span><span>Pechverhelping aan huis <small>Platte batterij/band, sleutels in je wagen</small></span><span>Nazicht keuring</span><span>Keuring</span><span>Reisnazicht</span><span>Expertise na ongeval</span></div></div><aside class="gb-side-card"><img class="gb-page-network-logo" src="'.esc_url($network).'" alt="1,2,3 AutoService"><h3>Persoonlijke garageservice</h3><p>Een lokaal aanspreekpunt met technische kennis, snelle service en transparante communicatie.</p><a href="tel:+32477353547">+32 477 35 35 47</a></aside></div>';
...
function gb_about_shortcode(){
    $content='<div class="gb-content-grid"><div><h2>Een lokale garage met een eigen verhaal</h2><p>Garage Barnes groeide vanuit passie voor techniek en persoonlijke service. Peter Barnes startte de garage in bijberoep in 2012, ging in 2015 voltijds verder en verhuisde in 2019 naar de KMO-zone ’t Zonneke in Hamme.</p><p>Doorheen de jaren werd het aanbod uitgebreid met een eigen takeldienst, zodat klanten voor onderhoud, herstellingen én pechhulp bij één vertrouwd aanspreekpunt terechtkunnen.</p><h3>Ons team</h3><div class="gb-team-grid"><div><strong>Peter Barnes</strong><span>Oprichter/eigenaar · Onthaal · Technieker · Takelaar</span><span><a href="tel:+32492061545">+32 492 06 15 45</a><br><a href="mailto:peter@garagebarnes.com">peter@garagebarnes.com</a></span></div><div><strong>David Barnes</strong><span>Administratie · Boekhouding</span><span><a href="mailto:info@garagebarnes.com">info@garagebarnes.com</a></span></div><div><strong>Melvin Barnes</strong><span>Onthaal · Administratie</span><span><a href="mailto:info@garagebarnes.com">info@garagebarnes.com</a></span></div></div></div><aside class="gb-side-card"><h3>Garage Barnes BV</h3><p>Zonneke 4<br>9220 Hamme</p><p>Ma–Vr<br>08:30–12:00<br>13:00–18:00<br>Za–Zo gesloten</p></aside></div>';
...
function gb_contact_fixed_top(){
    ...
    <div class="gb-contact-fixed">
      ...
      <section class="gb-page-content gb-contact-cards-section"><div class="gb-shell"><div class="gb-contact-cards"><div><span>Garage</span><h3>Afspraak & informatie</h3><a href="tel:+32477353547" style="display:block">+32 477 35 35 47</a><a href="mailto:info@garagebarnes.com" style="display:block">info@garagebarnes.com</a></div><div><span>Takeldienst 24/7</span><h3>Pech of ongeval</h3><a href="tel:+32477353547">+32 477 35 35 47</a></div><div><span>Adres</span><h3>Garage Barnes BV</h3><p>Zonneke 4<br>9220 Hamme<br>België</p></div><div><span>Openingsuren</span><h3>Maandag – vrijdag</h3><p>08:30–12:00<br>13:00–18:00<br>Zaterdag–zondag gesloten</p></div></div></div></section>
    </div><?php
    return ob_get_clean();
}
...
function gb_contact_cta(){
    ob_start(); ?>
    <section class="gb-page-cta"><div class="gb-shell gb-page-cta-inner"><div><span class="gb-kicker">Garage Barnes · Hamme</span><h2>We helpen u graag verder.</h2></div><a class="gb-button gb-button-green" href="tel:+32477353547">Bel ons</a></div></section><?php
    return ob_get_clean();
}
