...
function gb_homepage_shortcode() {
    ...
    <main class="gb-home">
        ...
        <section class="gb-home-slogan"><div class="gb-container gb-home-slogan-inner"><div class="gb-home-slogan-heading"><span class="gb-kicker">Onze mentaliteit</span><h2>Waar anderen stoppen,<br><strong>beginnen wij.</strong></h2></div><div class="gb-home-slogan-copy"><p>Bij Garage Barnes &amp; Takeldienst Barnes gaan we geen uitdaging uit de weg. Waar anderen u niet verder kunnen helpen, halen wij alles uit de kast om een oplossing te vinden.</p><p>Ook bij moeilijke takelingen gaan we niet opzij. We durven wel eens zeggen: <strong>“Gaat niet, bestaat niet.”</strong> En dat zegt exact waar wij voor staan.</p></div></div></section>
