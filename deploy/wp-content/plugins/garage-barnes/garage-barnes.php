...
define('GB_PLUGIN_VERSION', '0.3.0');
...
/**
 * One-time site bootstrap. Existing pages are never overwritten.
 */
function gb_bootstrap_site_pages() {
    if (get_option('gb_site_pages_v1_done')) {
        return;
    }
...
function gb_render_global_header() {
    ...
    $home = home_url('/');
    $garage = home_url('/auto-service/');
    $towing = home_url('/takeldienst/');
    $cars = home_url('/tweedehands/');
    $about = home_url('/over-ons/');
    $contact = home_url('/contact/');
    ?>
    <div class="gb-topbar">
        <div class="gb-shell gb-topbar-inner">
            <div>Zonneke 4 · 9220 Hamme</div>
            <div class="gb-topbar-links"><a href="tel:+3252570557">+32 52 57 05 57</a><a class="gb-topbar-towing" href="<?php echo esc_url($towing); ?>">Takeldienst 24/7</a></div>
        </div>
    </div>
    <header class="gb-site-header">
        <div class="gb-shell gb-header-inner">
            <a class="gb-brand" href="<?php echo esc_url($home); ?>" aria-label="Garage Barnes home">
                <span class="gb-brand-garage">Garage</span><span class="gb-brand-barnes">Barnes</span>
            </a>
            <nav class="gb-main-nav" aria-label="Hoofdnavigatie">
                <a href="<?php echo esc_url($home); ?>">Home</a>
                <a href="<?php echo esc_url($garage); ?>">Auto Service</a>
                <a href="<?php echo esc_url($towing); ?>">Takeldienst</a>
                <a href="<?php echo esc_url($cars); ?>">Tweedehands</a>
                <a href="<?php echo esc_url($about); ?>">Over ons</a>
                <a href="<?php echo esc_url($contact); ?>">Contact</a>
            </nav>
            <div class="gb-header-actions">
                <a class="gb-towing-mark" href="<?php echo esc_url($towing); ?>"><span>24/7</span> Takeldienst Barnes</a>
                <a class="gb-button gb-button-green" href="<?php echo esc_url($contact); ?>">Afspraak maken</a>
            </div>
        </div>
    </header>
    <?php
...
function gb_render_global_footer() {
    ...
    <footer class="gb-site-footer">
        <div class="gb-shell gb-footer-grid">
            <div class="gb-footer-brand">
                <div class="gb-brand gb-brand-footer"><span class="gb-brand-garage">Garage</span><span class="gb-brand-barnes">Barnes</span></div>
                <p>Garage, onderhoud, herstellingen, tweedehandswagens en takeldienst vanuit Hamme.</p>
                <span class="gb-network-note">Aangesloten bij 1,2,3 AutoService</span>
            </div>
            ...
            <div class="gb-footer-towing"><span class="gb-footer-label">Takeldienst Barnes</span><strong>24 uur / 7 dagen</strong><a class="gb-button gb-button-green" href="<?php echo esc_url(home_url('/takeldienst/')); ?>">Pechhulp &amp; takeldienst</a></div>
        </div>
        <div class="gb-shell gb-footer-bottom"><span>© <?php echo esc_html(wp_date('Y')); ?> Garage Barnes BV</span><span>Hamme, België</span></div>
    </footer>
    <?php
}
...
function gb_homepage_shortcode() {
    ...
    <main class="gb-home">
        <section class="gb-split-hero" aria-label="Garage Barnes en Takeldienst Barnes">
            <a class="gb-hero-panel gb-hero-garage" href="<?php echo esc_url($garage_url); ?>"><div class="gb-hero-overlay"></div><div class="gb-hero-content"><span class="gb-eyebrow">Garage Barnes · Hamme</span><h1>Garage &amp;<br>Auto Service</h1><p>Onderhoud, herstellingen en diagnose voor alle merken.</p><span class="gb-button gb-button-light">Ontdek de garage</span></div></a>
            <a class="gb-hero-panel gb-hero-towing" href="<?php echo esc_url($towing_url); ?>"><div class="gb-hero-overlay"></div><div class="gb-hero-content"><span class="gb-eyebrow">Takeldienst Barnes · 24/7</span><h2>Pech of ongeval?<br>Wij helpen.</h2><p>Voor particulieren, bedrijven, verzekeringen en pechbijstand.</p><span class="gb-button gb-button-green">Takeldienst 24/7</span></div></a>
        </section>
        ...
        <section class="gb-vehicles gb-container"><div class="gb-section-heading gb-heading-row"><div><span class="gb-kicker">Recent aanbod</span><h2>Tweedehandswagens</h2></div><a class="gb-text-link" href="<?php echo esc_url($cars_url); ?>">Bekijk alle wagens →</a></div><div class="gb-vehicle-placeholder-grid"><?php for ($i=0;$i<3;$i++): ?><article class="gb-vehicle-placeholder"><div class="gb-placeholder-image"><span>Voertuigfoto</span></div><div class="gb-placeholder-body"><span class="gb-placeholder-label">Binnenkort via Garage Barnes Vehicles</span><h3>Merk &amp; model</h3><div class="gb-placeholder-meta"><span>Bouwjaar</span><span>Km-stand</span><span>Brandstof</span></div><strong>€ —</strong></div></article><?php endfor; ?></div></section>
