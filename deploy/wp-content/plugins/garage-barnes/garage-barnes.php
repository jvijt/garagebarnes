...
function gb_homepage_shortcode() {
    ...
    <main class="gb-home">
        ...
        <section class="gb-home-slogan"><div class="gb-container gb-home-slogan-inner"><div class="gb-home-slogan-heading"><span class="gb-kicker">Onze mentaliteit</span><h2>Waar anderen stoppen,<br><strong>beginnen wij.</strong></h2></div><div class="gb-home-slogan-copy"><p>Bij <a href="<?php echo esc_url($garage_url); ?>">Garage Barnes</a> &amp; <a href="<?php echo esc_url($towing_url); ?>">Takeldienst Barnes</a> gaan we geen uitdaging uit de weg. Waar anderen u niet verder kunnen helpen, halen wij alles uit de kast om een oplossing te vinden.</p><p>Ook bij moeilijke takelingen gaan we niet opzij. We durven wel eens zeggen: <strong>“Gaat niet, bestaat niet.”</strong> En dat zegt exact waar wij voor staan.</p></div></div></section>
        ...
        <section class="gb-towing-band"><div class="gb-container gb-towing-band-inner"><div><span class="gb-kicker">Takeldienst Barnes</span><h2>Ook voor particulieren</h2><p>Pech, panne of ongeval in Hamme en ruime omgeving? Onze takeldienst staat klaar.</p></div><div class="gb-towing-actions"><a class="gb-button gb-button-green" href="tel:+32477353547">Bel +32 477 35 35 47</a><a class="gb-text-link" href="<?php echo esc_url($towing_url); ?>">Meer over takeldienst →</a></div></div></section>
