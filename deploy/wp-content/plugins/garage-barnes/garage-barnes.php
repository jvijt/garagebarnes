...
function gb_homepage_shortcode() {
    ...
    <main class="gb-home">
        ...
        <section class="gb-services gb-container">
            <article class="gb-service-card"><h3>Auto Service</h3><p>Klein en groot onderhoud, herstellingen, elektrische diagnose, airco, banden, batterijen, elektrische wagens en voorbereiding op de keuring.</p><a href="<?php echo esc_url($garage_url); ?>">Alle garagediensten →</a></article>
            <article class="gb-service-card gb-service-card-dark"><h3>Takeldienst 24/7</h3><p>Rechtstreeks bereikbaar voor particulieren bij panne, ongeval of pech. Ook actief voor bedrijven, verzekeraars en pechbijstandsorganisaties.</p><a href="<?php echo esc_url($towing_url); ?>">Naar de takeldienst →</a></article>
            <article class="gb-service-card"><h3>Tweedehandswagens</h3><p>Een wisselend aanbod zorgvuldig geselecteerde tweedehandswagens, binnenkort volledig beheerd via onze eigen Garage Barnes voertuigenmodule.</p><a href="<?php echo esc_url($cars_url); ?>">Bekijk het aanbod →</a></article>
        </section>
        ...
        <section class="gb-contact-strip"><div class="gb-container gb-contact-grid"><div><span>Garage &amp; afspraak</span><a href="tel:+32477353547">+32 477 35 35 47</a></div><div><span>Vaste lijn</span><a href="tel:+3252570557">+32 52 57 05 57</a></div><div><span>Adres</span><strong>Zonneke 4<br>9220 Hamme</strong></div><div><span>Openingsuren</span><strong>Ma–Vr 08:00–12:00<br>13:00–18:00</strong></div><a class="gb-button gb-button-green" href="<?php echo esc_url($contact_url); ?>">Contact &amp; afspraak</a></div></section>
